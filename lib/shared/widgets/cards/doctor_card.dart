...
/// A card widget that displays information about a doctor.
class DoctorCard extends StatefulWidget {
  /// Constructs a [DoctorCard] widget.
  const DoctorCard({
    super.key,
  ...
  /// The doctor object to display information about.
  final Doctor doctor;

  /// Whether to show the "About" section.
  final bool showAbout;

  /// Whether to show the "More Information" section.
